...
class PollsControllerTest < ActionController::TestCase
  ...
  test "should create poll" do
    assert_difference('Poll.count') do
      post :create, poll: { downvotes: @poll.downvotes, dtime: @poll.dtime, issue: @poll.issue, upvotes: @poll.upvotes }
    end
  ...
  test "should update poll" do
    patch :update, id: @poll, poll: { downvotes: @poll.downvotes, dtime: @poll.dtime, issue: @poll.issue, upvotes: @poll.upvotes }
    assert_redirected_to poll_path(assigns(:poll))
  end
